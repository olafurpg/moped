...
sealed abstract class JsonBuilder {
  def isPrimitiveBuilder = this.isInstanceOf[PrimitiveBuilder]
  def isArrayBuilder = this.isInstanceOf[ArrayBuilder]
  def isObjectBuilder = this.isInstanceOf[ObjectBuilder]
